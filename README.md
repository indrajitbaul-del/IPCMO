...
Features • Demo • Quick Start • Architecture • Screenshots
</div>
---
📋 Overview
...
🚀 Quick Start
Prerequisites
Node.js 22.5 or higher (download)
Windows / Linux / macOS
Installation
```bash
...
Run on a server PC (the server listens on `0.0.0.0:3000`)
Note its IP: `ipconfig` (e.g. `192.168.1.50`)
Open Windows Firewall for port 3000 (inbound TCP)
Other users access via `http://192.168.1.50:3000`
